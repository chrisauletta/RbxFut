                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-5">
                            <div class="table-responsive">
                                <table id="cliente" class="table table-striped table-bordered table-hover"
                                       style="width: 550px">
                                    <thead>
                                    <tr>
                                        <th>ID</th>
                                    ...
                                    foreach ($jogs as $jog) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn small"
                                                   href="showjogador.php?del=<?php echo $jog->getId() ?>" role="button">
                                                    <button type="button" class="btn btn-danger">Tirar</button>
                                                </a></td>
                                        </tr>
                                    <?php } ?>
                                </table>
